...
class SigLIPForExplainability(nn.Module):
    def __init__(self, model_name: str = "google/siglip-base-patch16-224", device: Optional[torch.device] = None):
        ...
        # 缓存
        self.attn_fwd: List[torch.Tensor] = []
        self.attn_bwd: List[torch.Tensor] = []
        self.pool_attn: Optional[torch.Tensor] = None
    ...
    def _attach_hooks(self):
        """给 encoder 每层 self_attn 注册 forward hook"""
